// Service Worker for AgriConnect PWA
...
self.addEventListener("push", (event) => {
  ...
  event.waitUntil(self.registration.showNotification("AgriConnect", options));
});
...
// Mock functions for offline actions (replace with real implementation)
